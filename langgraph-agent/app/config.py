...
RESOURCE_POSTGRES_STORAGE_WARN_MB = int(os.getenv("RESOURCE_POSTGRES_STORAGE_WARN_MB", "400"))
RESOURCE_POSTGRES_STORAGE_CRIT_MB = int(os.getenv("RESOURCE_POSTGRES_STORAGE_CRIT_MB", "480"))
RESOURCE_CONTAINER_MEM_WARN_PCT = float(os.getenv("RESOURCE_CONTAINER_MEM_WARN_PCT", "85"))
RESOURCE_CONTAINER_MEM_CRIT_PCT = float(os.getenv("RESOURCE_CONTAINER_MEM_CRIT_PCT", "95"))
